...
class IdeaTestSerializerTesCase(TestCase):
    ...
    def setUp(self):
        ...
        self.ideas = Idea.objects.select_related('author','categ').prefetch_related('tags').order_by('created_at')
...
"""
[OrderedDict([('id', 2), ('slug', 'second-idea'), ('title', 'second idea'), ('author', 1), ('lead_text', 'Greet 2'), ('main_text', 'Main text two'), ('owner_idea', 'jane'), ('categ_name', 'chat'), ('categ', 1), ('status', 0), ('an_likes', 1), ('avg_rate', '3.33'), ('featured', True), ('tags', ['mio'])]), 

OrderedDict([('id', 1), ('slug', 'first-idea'), ('title', 'first idea'), ('author', 1), ('lead_text', 'Greet 1'), ('main_text', 'Main text one'), ('owner_idea', 'jane'), ('categ_name', 'chat'), ('categ', 1), ('status', 1), ('an_likes', 3), ('avg_rate', '4.00'), ('featured', False), ('tags', ['zoo'])])]
